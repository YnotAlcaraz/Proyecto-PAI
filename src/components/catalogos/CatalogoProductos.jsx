...
export const CatalogoProductos = () => {
  ...
  const handleDelete = (key) => {
    fetch(
      `https://inventario-prueb-default-rtdb.firebaseio.com/products/${key}.json`,
      {
        method: "DELETE",
      }
    )
  ...
  const handleAddSave = () => {
    formRef.current.validateFields().then((values) => {
      ...
      fetch(
        `https://inventario-prueb-default-rtdb.firebaseio.com/products.json`,
        {
          method: "POST",
    ...
    <>
        ...
        <Form layout="vertical" ref={formRef}>
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Ingresa el código de barras del producto",
              },
            ]}
          >
            <InputNumber min={1} />
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Ingresa la existencia en inventario del producto",
              },
            ]}
          >
            <InputNumber min={1} />
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Ingresa la URL de la imagen del producto",
              },
            ]}
          >
            <Input />
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Ingresa la unidad de medida del producto",
              },
            ]}
          >
            <Input />
      ...
      >
        <Form
          layout="vertical"
          ref={formRef}
          initialValues={products.find((product) => product.key === editingKey)}
        >
          <Form.Item
            name="codigo_de_barras"
            label="Código de Barras"
