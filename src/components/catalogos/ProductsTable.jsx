    ...
    <div>
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.id}>
                ...
                <td>
                  <img
                    src={product.imagen_del_producto}
                    alt={product.nombre}
                    width="100px"
      ...
      <div className="container mt-4">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label htmlFor="existencia_en_inventario">
              Existencia en Inventario:
            </label>
            <input
              type="number"
              id="existencia_en_inventario"
              name="existencia_en_inventario"
              value={formData.existencia_en_inventario}
              onChange={handleChange}
            />
          </div>
          ...
          <div className="mb-3">
            ...
            <input
              type="text"
              id="imagen_del_producto"
              name="imagen_del_producto"
              value={formData.imagen_del_producto}
              onChange={handleChange}
            />
          </div>
